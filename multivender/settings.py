"""
Django settings for multivender project.
...
SECRET_KEY = 'django-insecure-$#($tp@258cl#knq@&ak(eap2=x*uu75159_ki@a%qkksjh%&e'
...
WSGI_APPLICATION = 'multivender.wsgi.application'
